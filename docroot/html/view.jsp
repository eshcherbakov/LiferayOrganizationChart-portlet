			...
			for(int i = 0; i < employees.size(); i++) {
				...
				%>
					<portlet:actionURL var="detailsURL" name="details">
						...
						<portlet:param name="employeeIndex" value="<%= String.valueOf(i) %>" />
					</portlet:actionURL>
					
					<div class="departmentManager employee employee<%= i % 5 %>">
						<a href="<%= detailsURL %>">
							<div class="portrait">
							...
							<div class="info">
								<div class="header">
									<span class="employeeName"><%= employee.getFullName() %></span><br />
								</div>
								<span class="employeeJob"><%= employee.getJobTitle() %></span>
							</div>
						</a>
					</div>
				<%
